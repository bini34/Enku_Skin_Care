...
<video
 ...
 <div className="md:w-[70%] w-full flex flex-col items-center align-middle gap-10 mb-28 ">
  <h1 className="text-white  text-5xl md:text-9xl text-center">Experience the art of skincare</h1>
  <p className="text-2xl">Find the right skincare services with our specialists.</p>
  <div className="w-full px-10 flex gap-5 justify-center">
