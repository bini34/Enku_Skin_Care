    ...
    <main className="w-full mn-h-[100vh]">
      <section className="h-[100vh] w-full flex justify-center items-center text-white">
        ...
        <div className="md:w-[70%] w-[90%] flex flex-col items-center align-middle gap-10 mb-28">
          <h1 className=" text-7xl md:text-9xl text-center">Experience the art of skincare</h1>
      ...
      >
        <div className="w-full flex flex-col justify-center items-center gap-5">
          ...
          <h1 className="md:text-2xl lg:text-5xl text-center text-black">
            To be a force for positive change in the beauty industry, advocating for inclusivity,
            diversity, and self-acceptance, while providing services that celebrate individual
        ...
        <div className="w-full flex lg:flex-row flex-col md:gap-10 gap-30">
          ...
          <div className="lg:w-[50%] w-full flex flex-col justify-center gap-6">
            ...
            <p className="text-xl text-black lg:text-left text-center">
              Step into our world and experience the power of transformation. Unleash your
              confidence and embrace your ageless beauty with us.
            </p>
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-l text-black lg:text-left text-center">
                  Discover the benefits of our modern cosmetology and dermatology equipment,
                  carefully selected to provide you with the best experience.
                </p>
              </div>
            </div>
            <div className="flex gap-5">
      ...
      >
        <div className="w-full flex flex-col justify-center items-center gap-5">
          ...
          <h1 className="md:text-2xl lg:text-5xl text-center text-black">
            With our cutting-edge techniques and advanced cosmetic procedures, we strive to bring
            out your unique beauty and help you shine.
          </h1>
        </div>
        <div className="w-full flex md:flex-row flex-col gap-10  justify-center">
          <div className="lg:w-[400px] md:w-[200px] w-full  flex flex-col gap-5">
            ...
            <div>
              <h2 className="lg:text-4xl md:text-3xl text-2xl text-black ">Dermatology</h2>
          ...
          <div className="lg:w-[400px] md:w-[200px] w-full mt-20 flex flex-col gap-5">
            ...
            />
            <div>
              <h2 className="text-4xl text-black ">Dermatology</h2>
              <p className="text-black">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Pariatur{' '}
              </p>
            </div>
      ...
      <section className="w-full m-h-[70vh] bg-[#c96c4e] flex lg:flex-row flex-col gap-2 justify-center items-center sm:p-15 p-5">
        <div className="sm:w-[500px]   w-full flex flex-col justify-center  items-center text-center bg-[#FFFFFFB3] p-10 gap-5">
          <div className="flex  gap-2 text-2xl text-[#c96c4e]">
            <StarFilledIcon className="" /> <StarFilledIcon /> <StarFilledIcon /> <StarFilledIcon />{' '}
            <StarFilledIcon />
          </div>
          <p className="text-xl text-[#2f2b2a]">
            The cosmetologists are highly skilled and knowledgeable, providing personalized
            recommendations and delivering outstanding results. I left feeling rejuvenated and
            confident.
          </p>
          <h2 className="text-lg text-[#2f2b2a]">
            By <span className="text-2xl">Sarah Thompson</span>
          </h2>
      ...
      <section
        className="w-full m-h-[70vh] flex gap-10  lg:flex-row flex-col justify-center items-center lg:p-2 md:p-20 p-5"
        style={{
