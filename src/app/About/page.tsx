    ...
    <main>
      <section className="w-full h-[52vh] flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center md:w-[70%] lg:w-[70%] w-full gap-5">
          <h2 className="text-amber-700 font-medium">ABOUT US</h2>
      ...
      <section className="w-full flex lg:flex-row flex-col md:gap-10 gap-30 p-10 pt-20 md:20">
        ...
        <div className="lg:w-[50%] w-full flex flex-col justify-center gap-6">
          <div className=" flex flex-col gap-2">
            <h2 className="text-amber-700 lg:text-left text-center">OUR STORY</h2>
          ...
          <p className="text-xl text-black lg:text-left text-center">
            We are a leading cosmetology and dermatology clinic dedicated to transforming beauty and
            enhancing confidence. Our team of highly skilled professionals combines artistry,
            advanced techniques, and cutting-edge technology to deliver exceptional results tailored
